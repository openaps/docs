...
\** Note: Several #OpenAPS contributors recommended the Raspberry Pi 2 CanaKit, which includes several essential accessories in one package can be purchased through [Amazon](http://www.amazon.com/CanaKit-Raspberry-Complete-Original-Preloaded/dp/B008XVAVAW/ref=sr_1_1?ie=UTF8&qid=1434523139&sr=8-1&keywords=canakit+raspberry+pi+2)
