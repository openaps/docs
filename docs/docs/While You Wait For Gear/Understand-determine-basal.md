...
* meal.json = `{"carbs":0,"boluses":0}`
  ...
  * `boluses` = amount of bolus insulin delivered
  ...
  Those data come from what you entered into your pump or Nightscout web app. If provided, they allow determine-basal to decide when it is appropriate to enable Meal Assist.
