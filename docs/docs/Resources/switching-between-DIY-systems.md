...
* [Follow these instructions](<../Build Your Rig/install-overview>) (with pictures!)
...
* After you get comfortable with how OpenAPS operates, you can easily [(here's how)](<../Usage and maintenance/preferences-and-safety-settings#editing-your-preferences-json>) update this number later. 
...
* Read about [all of the other optional safety settings here](<../Usage and maintenance/preferences-and-safety-settings>).
...
* **Override the high target with the low** ([see this explanation](<../Usage and maintenance/preferences-and-safety-settings#wide-bg-target-range>) about this feature which is enabled by default
...
* **Carb ratio adjustment ratio** ([see this explanation](<../Usage and maintenance/preferences-and-safety-settings#carbratio-adjustmentratio>) for enabling this feature)
 ...
 * [Bluetooth tethering](<../Usage and maintenance/Wifi/bluetooth-tethering-edison>) is one good option; as soon as you walk out of wifi range, it can automatically bluetooth tether to your phone to get connectivity
...
* OpenAPS will also default to always setting a temp basal (this can be turned off; [see description here](<../Usage and maintenance/preferences-and-safety-settings#skip-neutral-temps>)), which means it’ll be easier to look down at the pump and see if a temp basal is active to know that the loop has been working recently.
