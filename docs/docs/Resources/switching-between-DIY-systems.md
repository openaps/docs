...
* Read about [all of the other optional safety settings here](<../Usage and maintenance/preferences-and-safety-settings#understanding-your-preferences-json>).
...
* **Override the high target with the low** ([see this explanation](<../Usage and maintenance/preferences-and-safety-settings#override-high-target-with-low>) for enabling this feature)
