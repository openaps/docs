...
* If running more then one rig, you will want to make sure all rigs are running the same version of OpenAPS version starting with 0.5.1 (even if SMB is not enacted on all rigs, all rigs need to know about it)
