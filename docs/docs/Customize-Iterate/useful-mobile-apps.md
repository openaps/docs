...
**mmtune** - If you want to check how well your pump tune strength is you can use this command script to test it `cd ~/myopenaps && sudo service cron stop && pkill -f openaps ; pkill -f oref0-pump-loop; oref0-mmtune && sudo service cron start`
