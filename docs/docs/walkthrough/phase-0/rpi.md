...
If you require a full graphical user interface on your Raspberry Pi, download the latest version of Raspbian [here](http://downloads.raspberrypi.org/raspbian_latest).   downloads.raspberrypi.org/raspbian/release_notes.txt has this note: 
2016-11-25:
