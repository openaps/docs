...
Login as root (with the password you just set above), and run (first line will be quick, second and third lines will take awhile.  Run each line separately until finished):
