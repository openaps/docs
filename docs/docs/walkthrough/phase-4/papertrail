...
If you want to remotely view the rig's logs/loops, you can use Papertrail service.  For single rig monitoring, you should be able to use the free Papertrail account.  Use of this service can help you remotely troubleshoot when the rig has an error.
...
![Papertrail hosting information](h../Images/papertrail_host.png)
