...
To get aliases:
(notice; be careful with this script, you will want to make sure that the script references the report names that you created.  Recommend copying the code into a text editor, change the report names to the names that you set up, and then running the script to complete this step.)
